...
export default function Product({ params }: { params: { id: string } }) {
	...
	function onAddCart() {
		if (user.success) {
			customAxios.post(`/api/nest/cart/create`, {
				user: user.data.uuid,
					...
					<div className="flex flex-col justify-between lg:w-1/2 w-full lg:pl-10 lg:py-2 mt-6 lg:mt-0">
						...
						<div className="flex flex-col pt-5 border-t-2 border-gray-100">
							...
							<div className="flex">
								...
								<Link
									href="checkout"
									className="flex-grow ml-4 text-white text-center bg-teal-600 border-0 py-2 px-6 focus:outline-none hover:bg-teal-600 rounded"
								>
									구매하기
								</Link>
							</div>
