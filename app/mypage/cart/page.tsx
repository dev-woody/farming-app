...
export default function CartModule() {
	...
	const shipping_fee_total_amount = cartData!.cart_items.reduce(
		(total, item) => {
			if (item.total_amount > item.product.free_shipping_amount) {
				return total + item.product.shipping_fee;
			}
			return total;
		},
		0,
	...
	return (
		<section className="container px-5 md:py-12 py-2 mx-auto text-gray-600 body-font overflow-hidden">
							...
							<div className="flex justify-between">
								...
								<div className="">
									<p className="mb-1 text-lg font-bold">
										{cart_total_amount + shipping_fee_total_amount}&nbsp;원
									</p>
								</div>
							</div>
							<Link
